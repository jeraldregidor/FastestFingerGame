...
import { soundsOn } from "../app/welcomeSlice";

const Welcome = () => {
  const dispatch = useDispatch();
  const handleLestsGoButton = () => {
    dispatch(soundsOn());
    dispatch(openModal());
  };
  return (
    <div className="grid grid-cols-[1fr_2fr] gap-4 h-screen select-none">
      <section>
        <Ranking />
      </section>
